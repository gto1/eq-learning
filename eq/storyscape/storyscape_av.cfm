...
function validate_form ( )
{
    valid = true;
	    ...
	    if ( document.Storyscape.Email.value == "" )
    {
...
<img src="http://www.gregory-otoole.com/images/narrative_thumb.jpg" align="left" alt="Digital Narrative"  width="90px" height="119px" border="0"></a>
  ...
  <strong>ONGOING COURSE CONTENT</strong><br>
    ...
    creation tool. Registered students of Net Art + Design ARTD 2355 + DMST 4355 
    only please.<br>
	<font size="1"><cfif IsDefined ('Session.Avatar')>
      <cfoutput><font color="##0099CC">Welcome, #Session.Avatar#</font></cfoutput> 
      <cfelseif Not IsDefined ('Session.Avatar')><a href="../../narrative/storyscape.cfm">Story</a> &nbsp; 
	  <a href="../../narrative/storyscape_sign.cfm">Sign-in</a> &nbsp; <a href="../../narrative/storyscape_reg.cfm">Register new user</a></cfif> &nbsp; 
...
<tr><td colspan="2"><font size="2" face="Courier new, Arial">
