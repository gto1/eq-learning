...
<img src="http://www.gregory-otoole.com/images/narrative_thumb.jpg" align="left" alt="Digital Narrative"  width="90px" height="119px" border="0"></a>
	...
	&nbsp; <a href="../../narrative/resources.cfm" target="_parent">Resources</a>	
	</font> <br>  <br>
  <strong>ONGOING COURSE CONTENT</strong><br>
    ...
    The Storyscape&#8482; is a time-based interactive online content generating environment. It 
	...
	<font size="1"><cfif IsDefined ('Session.Avatar')>
      <cfoutput><font color="##0099CC">Welcome, #Session.Avatar#</font> &nbsp; <a href="../../narrative/storyscape_write.cfm">Write</a> </cfoutput> 
      <cfelseif Not IsDefined ('Session.Avatar')><a href="../../narrative/storyscape_sign.cfm">Sign-in</a> &nbsp; <a href="../../narrative/storyscape_reg.cfm">Register new user</a> &nbsp; </cfif> &nbsp; <a href="../../narrative/storyscape_av.cfm">Avatars</a> &nbsp;
	  <cfif IsDefined ('Session.Avatar')>
      <cfoutput> <a href="../../narrative/storyscape_sign.cfm?logout=yes">Sign-out</a></cfoutput></cfif></font> <br>
    <br>
			 
<table width="100%" cellpadding="0" border="0" cellspacing="0" bgcolor="#FFFFFF" height="350px">
<tr>
        <td valign="top" height="350px"><font face="Arial, Courier New, Courier, mono" color="#000000" size="2"> 

<!-- =============Insert frame here -->

<iframe src="docuframe.cfm" align="left" frameborder="0" height="350px" width="100%" name="Docuframe" scrolling="auto"></iframe>
